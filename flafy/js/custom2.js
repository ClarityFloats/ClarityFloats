	...
	jQuery(function ($) {
		$(document).ready(function () {
			...
			$(function () {
				...
				var mothersDayStart = new Date("April 24, 2026");
				var mothersDayEnd = new Date("May 11, 2026");
				...
				var holidayStartDate = new Date("December 8, 2025");
				var holidayEndDate = new Date("December 31, 2025");
